...
udp_host = '192.168.137.190'  # Listen on all available network interfaces
udp_port = 4210  # Should be the same as the port in the robot program
BUFFER_SIZE = 1024


sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
# sock.bind((udp_host, udp_port))  # Try to bind to the ESP's IP address and port
